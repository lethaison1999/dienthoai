			...
			<div class="preload"><div></div></div>
				<div id="lof-main-outer">
					<ul class="lof-main-wapper">
						<li><img src="img/slide/s20-plus-pc-banner.jpg" width="1000" height="350"></li>
						<li><img src="img/slide/banner-htc-800x300.png" width="1000" height="350"></li>
						<li><img src="img/slide/banner-iphone-12.jpg" width="1000" height="350"></li>
					...
					<div onClick="return false" href="" class="lof-next">Next</div>
					  <div class="lof-navigator-outer">
							<ul class="lof-navigator">
							   <li><img src="img/slide/s20-plus-pc-banner.jpg" width="70" height="25" /></li>       		
							   <li><img src="img/slide/banner-htc-800x300.png" width="70" height="25" /></li>       		
							   <li><img src="img/slide/banner-iphone-12.jpg" width="70" height="25" /></li>       		
